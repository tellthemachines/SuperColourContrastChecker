...
// ttm introduced border radiuses :P
...
var jscolor = {
	...
	color : function(target, prop) {
		...
		function drawPicker(x, y) {
			...
			p.boxB.style.borderRadius = THIS.pickerBorderRadius + 'px';

			// pad image
			p.pad.style.width = jscolor.images.pad[0]+'px';
			p.pad.style.height = jscolor.images.pad[1]+'px';
			p.pad.style.overflow = "hidden";
			...
			p.padB.style.borderRadius = THIS.pickerBorderRadius + 'px';
